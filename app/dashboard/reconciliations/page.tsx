...
import { Scale, ChevronRight, CheckCircle, AlertTriangle, Clock, Loader2 } from "lucide-react"
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-500 max-w-md mx-auto">
            Set up your first reconciliation from any task&apos;s detail page by clicking the &quot;Reconciliation&quot; tab.
          </p>
        </div>
      ) : (
