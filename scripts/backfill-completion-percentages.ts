/**
 * Backfill Script: Calculate completion percentages for existing tasks with replies
 * 
 * This script processes all tasks that have inbound messages (replies) but don't
 * have a completionPercentage set yet. It analyzes the latest reply with LLM
 * to determine the completion percentage based on intent.
 */
...
export { backfillCompletionPercentages }
