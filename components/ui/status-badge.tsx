...
const statusStyles: Record<string, { bg: string; text: string; label: string }> = {
  ...
  REPLIED: { bg: 'bg-blue-100', text: 'text-blue-700', label: 'Replied' },
  READ: { bg: 'bg-purple-100', text: 'text-purple-700', label: 'Read' },
  SEND_FAILED: { bg: 'bg-red-100', text: 'text-red-700', label: 'Failed' },
  // Note: COMPLETE is already defined above in Job statuses
  
  // Legacy Task/Request statuses (mapped to new display)
  AWAITING_RESPONSE: { bg: 'bg-amber-100', text: 'text-amber-700', label: 'No reply' },
  HAS_ATTACHMENTS: { bg: 'bg-blue-100', text: 'text-blue-700', label: 'Replied' },
  VERIFYING: { bg: 'bg-blue-100', text: 'text-blue-700', label: 'Replied' },
  FULFILLED: { bg: 'bg-green-100', text: 'text-green-700', label: 'Complete' },
  REJECTED: { bg: 'bg-green-100', text: 'text-green-700', label: 'Complete' },
  FLAGGED: { bg: 'bg-amber-100', text: 'text-amber-700', label: 'No reply' },
  MANUAL_REVIEW: { bg: 'bg-amber-100', text: 'text-amber-700', label: 'No reply' },
  ON_HOLD: { bg: 'bg-amber-100', text: 'text-amber-700', label: 'No reply' },
